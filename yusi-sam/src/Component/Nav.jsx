...
export const Nav = () => {
    ...
    return (
        <div>
            ...
            <div id='nav_p'>
                <div>
                  <Link to={"/"}>  <img className='logoclue' src="https://images.shopclues.com/images/ui/shopclues_logo@2x.png" alt=""/></Link>
                </div>
                <div className='join'>
                    <input
                        type="text"
            ...
            <div id='nav_t'>
                ...
                <button value={"mobile_more"} onClick={temp} id='btn1'>Mobiles & more</button>
                
                <button value={"men"} onClick={temp} id='btn1'>Men</button>
                <button value={"women"} onClick={temp} id='btn1'>Women</button>
                <button value={"home_kitchen"} onClick={temp} id='btn1'>Home & Kitchen</button>
                <button value={"appliances"} onClick={temp} id='btn1'>Appliances</button>
                <button value={"Sport_more"} onClick={temp} id='btn1'>Sports & More</button>
                <button value={"essential"} onClick={temp} id='btn1'>Essentials</button>
                <button value={"offers"} onClick={temp}id='btn1'>Offers</button>
                <button value={"global"} onClick={temp}id='btn1'>Global Shopping</button>
      ...
      <ul>
                     ...
                     <Link to={"/product"}> <li>Sarees</li></Link>
                      <li>Kurtas & Kurtis</li>
      ...
      <div className="popup" style={{ display: poptemp.global }}>
